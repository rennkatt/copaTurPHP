    ...
    <body id="body"  onload="load()">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <a href="historia_cadastra.php" type="button" class="btn btn-primary page-header pull-right"><i class="fa fa-plus"></i> Nova Publicação</a>
                </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover " id="dataTables-example">
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeA">
                                        ...
                                        <td class="td-actions">
                                           <a href="historia_edita.php?id=<?php echo $mostra->id;?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"> </i></a>
                                            <a href="historia_gerencia.php?delete=<?php echo $mostra->id;?>" class="btn btn-danger btn-sm" onClick="return confirm('Deseja realmente exluir o post?')" ><i class="fa fa-times"> </i></a>
