...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body id="body"  onload="load()">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header" style="text-align: center;" >Editar Ponto Turístico</h3>
                    	<!-- Altera aqui -->
                ...
                <div class="col-lg-12">
                     <form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class=" col-lg-12 pad10 hidden">
				            ...
				            <input type="text" class="form-control" id="categoria" value="ponto turistico" name="categoria">
                        ...
                        <div class="form-actions col-lg-12">
							...
							<a href="ponto_turistico_gerencia.php" class="btn btn-block btn-warning" value="Cancelar" >VOLTAR</a>
							<a href="ponto_turistico_gerencia.php?delete=<?php echo $id;?>" class="btn btn-danger btn-block" onClick="return confirm('Deseja realmente exluir o post?')">EXCLUIR PUBLICAÇÃO</a>
						</div> <!-- altera aqui. -->
