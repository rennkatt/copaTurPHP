...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body id="body"  onload="load()">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-9">
                    <h3 class="page-header" style="text-align: center;" >Publicações sobre as comidas típicas das cidades</h3>
                                <!-- Edita aqui...  -->
                </div>
                <div class="col-lg-3">
                    <a href="comidas_cadastra.php" type="button" class="btn btn-primary page-header pull-right"><i class="fa fa-plus"></i> Nova Publicação</a>
                </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover " id="dataTables-example">
                                ...
                                <?PHP
                                        ...
                                        try{
                                            $select = "SELECT * from tb_postagens WHERE categoria = 'comidas' ORDER BY cidade";
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeA">
                                        ...
                                        <td class="td-actions">
                                           <a href="comidas_edita.php?id=<?php echo $mostra->id;?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"> </i></a>
                                            <a href="comidas_gerencia.php?delete=<?php echo $mostra->id;?>" class="btn btn-danger btn-sm" onClick="return confirm('Deseja realmente exluir o post?')" ><i class="fa fa-times"> </i></a>
