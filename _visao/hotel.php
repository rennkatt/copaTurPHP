            ...
            <div class="overlay">
                <div class="container">
                    <div class="intro-text">
                        ...
                        <h1>Hotéis de <span><?php echo $_GET['cidade']?></span></h1>
                       		<ol class="breadcrumb">
                                    ...
                                    <?php echo ($descricao)?>
                                     ...
                                     <div class="share-links">
                                        ...
                                        <div class="share-links-wrap">
                                            ...
                                            <a rel="nofollow" target="_blank" href="mailto:?subject=Eu quero que veja essa postagem&amp;body=Olha esta postagem : Hotéis de <?php echo ($cidade)?> - http://copatur-com-br.umbler.net/_visao/hotel.php?cidade=<?php echo ($cidade)?>" title="Mande esta postagem por e-mail"><i class="pw-icon-mail"></i></a>
                                            
                                            <a rel="nofollow" target="_blank" href="https://plus.google.com/share?url=http://copatur-com-br.umbler.net/_visao/hotel.php?cidade=<?php echo ($cidade)?>" title="Compartilhe esta postagem no Google+"><i class="pw-icon-gplus"></i></a>
                                            
                                            <a rel="nofollow" target="_blank" href="http://twitter.com/home?status=http://copatur-com-br.umbler.net/_visao/hotel.php?cidade=<?php echo ($cidade)?>" title="Compartilhe esta postagem no Twitter"><i class="pw-icon-twitter"></i></a>
                                              
                                            <a rel="nofollow" target="_blank" href="http://www.facebook.com/sharer.php?u=http://copatur-com-br.umbler.net/_visao/hotel.php?cidade=<?php echo ($cidade)?>" title="Compartilhe esta postagem no Facebook"><i class="pw-icon-facebook"></i></a>
